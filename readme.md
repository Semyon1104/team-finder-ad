...
Проект реализован для `TASK_VERSION=1` (страница избранного и фильтры пользователей).
...
3. Примените миграции:
   ...
   ```
4. Создайте тестовые данные для проверки - пользователи и проекты:
   ```bash
   python manage.py seed_demo_data
   ```
5. Создайте суперпользователя (опционально, для проверки админки):
   ```bash
...
- Избранное (`/projects/favorites/`): добавление/удаление с карточек и страницы проекта.
- Пользователи (`/users/list/`): карточки, пагинация по 12, 4 фильтра варианта 1.
